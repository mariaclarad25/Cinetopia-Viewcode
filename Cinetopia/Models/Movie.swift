...
/*let movies: [Movie] = [
    ...
    Movie(id: "3", title: "Avatar: O Caminho da Água", image: "Avatar2", synopsis: "Após anos entre os Na'vi, Jake Sully construiu uma família com Neytiri e se tornou parte de Pandora. Quando os humanos retornam com novas ameaças, Jake e sua família deixam a floresta e buscam abrigo entre os Metkayina, um clã que vive nos recifes. Lá, enfrentam desafios para se adaptar ao modo de vida aquático. Com a guerra se aproximando, Jake precisa proteger sua família e lutar pela sobrevivência do novo lar.", rate: 7.5, releaseDate: "15/12/2022"),
